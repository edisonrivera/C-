...
int menu_medicos (int opm){
    ...
    cout<<setw(67)<<"| 4.- VOLVER AL MENU PRINCIPAL |"<<endl;
    cout<<setw(67)<<"|______________________________|"<<endl;
    cout<<"\n"<<setw(60)<<">INGRESE SU OPCION: ";
    cin>>opm;
    while (opm<1 || opm>4){
...
void eliminar_medicos (tLista2 &lista2){
    ...
    for (int i = 0; i < lista2.cont2; i++){
        ...
        if (lista2.datosDoctor[i].nif == aux){
            ...
            lista2.cont2--;
            cout<<setw(65)<<"! DOCTOR ELIMINADO EXITOSAMENTE !"<<endl;
	    }
	    else {
		a = false;
        cout << setw(65)<<"! DOCTOR INEXISTENTE !" << endl;
	    }
    }
    sleep (4);
}
...
void agregarcitas (tFormulario formulario, tLista &lista){
    ...
    if (lista.cont < MAX){
        cout<<setw(60)<<"---------------- INFORMACION CITA -----------------"<<endl;
        cout<<setw(55)<<"> NOMBRE COMPLETO: ";
        ...
        while (formulario.edad < 0){
            cout<<setw(55)<<"! INGRESE NUMEROS VALIDOS !"<<endl;
            cout<<setw(55)<<"> EDAD: ";
            cin>>formulario.edad;
        }
        cin.ignore();
